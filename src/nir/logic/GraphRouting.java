...
public class GraphRouting {
    ...
    public GraphRouting(Coordinate start, Coordinate end){
        this.start = start;
        this.end = end;
    }
    ...
    public void generateCoordinates(Coordinate[] in , Coordinate start, Coordinate end){
        coordinates.clear();
        coordinates.add(start);
        for (Coordinate coordinate : in) {
            if (Intersection.isIntersect(coordinate, ObstacleList.obstacles)){
