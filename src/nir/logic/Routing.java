...
public class Routing {
    ...
    public static int antNumber = 10;
    public static int iterationNumber = 50;
    public static double p = 0.9; // evaporation coefficient
    public static double v = 10; // pheromone size, generated by ant
    ...
    public Routing(Coordinate start, Coordinate end, int nVerticles){
        this.start = start;
        this.end = end;
    ...
    public Route generateRoute(){
        ...
        for (int i = 0; i < iterationNumber; i++) {
            for (Ant ant : ants) {
                ...
                double routeSize = calculateRouteSize(route);
